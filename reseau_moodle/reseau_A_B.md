...
# 4 critères:
    ...
    Perf:
        ...
        - latence (tps de propagation): Tps pour premier bit de la source a la dest. Exprimé en ms ou µs.
          --latence -> Reseau rapide.
        - Exemples:
            -> PAN: latence faible, car courte distance à parcourir.
            -> Satellite: latence élevé, car longue distance.
            -> Reseau optique: vitesse de propagation proche de celle de la lumière, débit eleve.
        - latence dépend de la distance parcourue, car tous les supports +/- la meme vitesse (proche de celle de la lumière).
        - debit, mesure la capacité de transmission des infos d'une carte reseau.
        - RTT (Round Trip Time):
            - mesure le temps qu'il faut à un bit pour effectuer l'aller/retour entre deux equipements.
            - permet de verif si une trame de données à bien été recu, grace à la notion d'acquittement.
            - RTT = 2 fois le temps de la propagation. (distance facteur important).
            -> RTT = 2 * Tp
